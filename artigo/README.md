...
Ações são tasks individuais que podem ser combinadas para criar jobs e customizar fluxos de trabalho, ajudando a diminuir a quantidade repetitiva de código. Você pode utilizar as actions publicadas no GitHub Marketplace ou criar e customizar suas próprias actions.
